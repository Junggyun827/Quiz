...
public class QuizServer {
    ...
    private static final List<String[]> QUESTIONS = Arrays.asList(
        new String[]{"Quiz#1 : What is this lecture name?", "a) Computer and network", "b) Programming", "c) Algorithm", "d) Database", "a"},
        new String[]{"Quiz#2 : Which is our college name?", "a) Seoul", "b) Yonsei", "c) Gachon", "d) Korea", "c"},
        new String[]{"Quiz#3 : Who are you?", "a) Joe baiden", "b) student", "c) God", "d) Trumph", "b"}
    );
